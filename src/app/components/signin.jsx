                        ...
                        {showSignIn &&
                            <div className={signinStyles.form_container}>
                                        ...
                                        {formFields.map((item, index) =>
                                            <Col lg={12} key={index}>
                                                <Form.Group className="mb-3" controlId={item.name}>
                                                    ...
                                                    <Form.Control type={item.type} placeholder={item.placeholder} className={`${item.id === 2 ? signinStyles.password_input : signinStyles.email_input} border-0 border-bottom`} />
                                                </Form.Group>
                                            </Col>
                                        )}
                                    </Row>
                                ...
                                <div className='py-4 d-flex align-items-center justify-content-between'>
                                    ...
                                    <div>
                                        <Button variant='primary' className={signinStyles.form_btn}>Sign In</Button>
                                    </div>
                                </div>
                            </div>
                        }
                                    ...
                                    <Row>
                                        <Col lg={12}>
                                            <Form.Group className="mb-3" controlId='email'>
                                                ...
                                                <Form.Control type='email' placeholder='Enter Email' className={`${signinStyles.email_input} border-0 border-bottom`} />
                                            </Form.Group>
                                        </Col>
                                    </Row>
                                </Form>
                                <div className='py-4'>
                                    <Button variant='primary' onClick={() => { setShowNewPassword(true); setShowForgotPassword(false) }} className={signinStyles.form_btn}>Continue</Button>
                                </div>
                            </div>
                        }
                        {showNewPassword &&
                            <div className={signinStyles.form_container}>
                                    ...
                                    <Row>
                                        <Col lg={12}>
                                            <Form.Group className="mb-3" controlId='password'>
                                                ...
                                                <Form.Control type='password' placeholder='Enter Password' className={`${signinStyles.password_input} border-0 border-bottom`} />
                                            </Form.Group>
                                ...
                                <div className='py-4'>
                                    <Button variant='primary' onClick={() => { setShowNewPassword(false); setShowSuccess(true) }} className={signinStyles.form_btn}>Update Password</Button>
                                </div>
                            </div>
                        }
                        {showSuccess &&
